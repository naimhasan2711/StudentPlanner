...
fun LectureCard(
    ...
    if (showDeleteDialog) {
        AlertDialog(
            ...
            title = { Text(stringResource(R.string.dialog_delete_lecture_title)) },
            text = { 
                Text(
                    stringResource(
                        R.string.dialog_delete_lecture_message, 
                        lecture.title
                    )
                ) 
            },
                        ...
                        Surface(
                            ...
                            IconButton(
                                ...
                                Icon(
                                    ...
                                    contentDescription = stringResource(R.string.cd_delete_lecture),
